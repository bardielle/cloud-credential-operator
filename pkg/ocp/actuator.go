...
const (
	...
	KubevirtCredentials = "kubevirt-credentials"
	KubevirtCredentialsNamespace = "kube-system"
...
func (a *OCPActuator) createSecret(ctx context.Context, cr *minterv1.CredentialsRequest, logger log.FieldLogger) error {
	...
	if err := a.Client.Get(context.TODO(), types.NamespacedName{Namespace: KubevirtCredentialsNamespace, Name: KubevirtCredentials}, kubevirtCredentialsSecret); err != nil {
		return err
	}
